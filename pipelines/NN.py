...
if __name__ == "__main__":
    ...
    with start_run():
        ...
        loss_function = nn.BCEWithLogitsLoss(
            pos_weight=tensor([pos_weight], device=device)
        )
        ...
        s = summary(event_model, input_size=(1, len(exog_cols)), verbose=0)
        log_text(str(s), "model_summary.txt")
        ...
        for i in range(epochs):
            ...
            log_metric("train/loss", train_loss, step=i)
            ...
            log_metric("val/loss", val_loss, step=i)
        ...
        for _metric in scoring_functions.keys():
            ...
            log_metric(f"val/{_metric}", score)
        ...
        for _metric in scoring_functions.keys():
            ...
            log_metric(f"test/{_metric}", score)

        log_model(event_model, name="model")
